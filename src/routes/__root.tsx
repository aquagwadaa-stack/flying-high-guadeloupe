...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Découvrez le trapèze volant au Helleux, Sainte-Anne. Séances dès 7 ans, débutants bienvenus. Réservation en ligne." },
      { name: "author", content: "Trapez'cool" },
      { property: "og:title", content: "Trapez'cool — Trapèze volant en Guadeloupe" },
      { property: "og:description", content: "Prenez votre envol au Helleux, Sainte-Anne. Séances pour tous les niveaux, dès 7 ans." },
